...
typedef std::map<mnemonic,info_register>  MapType2;
...
int register_no(char a)
//function to check the register number
{
    if(a=='A') return 0;
    if(a=='X') return 1;
    if(a=='L') return 2;
...
/*---------OPTABLE-----------*/
void create()
//generating the opcode table for checking the valid opcode in input file
{
